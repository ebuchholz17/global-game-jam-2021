...
You have stumbled upon the ruins of a great castle, its glory days 
...
LOOK                               (examine your surroundings)       Shortcuts: L
NORTH, SOUTH, EAST, WEST, UP, DOWN (move to a new room)              Shortcuts: N, S, E, W, U, D
TAKE                               (take an item in the room)
INVENTORY                          (check your inventory)            Shortcuts: I
...
your console settings (Right click title bar -> Properties)
```
