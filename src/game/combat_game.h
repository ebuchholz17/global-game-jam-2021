...
#define GOBLIN_SPEED 4.0f
#define SNAKE_SPEED 15.0f
#define SNAKE_CHARGE_SPEED 30.0f
#define DRAGON_ACCELERATION 5.0f
#define FIRE_SPEED 25.0f
#define ARROW_SPEED 25.0f
#define KNOCKBACK_SPEED 20.0f
